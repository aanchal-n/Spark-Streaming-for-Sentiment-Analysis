...
if __name__ == "__main__":
    ...
    models = [cluster_model.Model(classifier, classifier.__name__, classifiers_and_parameters[classifier], load_model=True) for classifier in classifiers_and_parameters]
    for model in models:
